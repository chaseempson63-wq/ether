...
export const memoryNodes = pgTable("memory_nodes", {
  ...
  // Short ALL CAPS 2-3 word concept label generated by Venice at create time
  // ("BROKE MY LEG", "FIRST JOB", "LOST FAITH"). Rendered on the mind map
  // canvas. Falls back to summary/content when null (pre-labeler nodes).
  label: text("label"),
